...
// ---------------------------------------------------------------------------
// "What strong readiness looks like" — concrete best-practice exemplars for the
// readiness dimensions (R1-R12). Richer and more tangible than the High-score
// descriptor; grounded in real NHS/UK artefacts. Surfaced in the readiness card
// toggle alongside the tools that help build each one.
// See docs/decisions/0005-readiness-resources.md.
// ---------------------------------------------------------------------------

export const bestPracticeByDimension: Record<string, string> = {
  R1: "A standing AI governance group with clinical, technical, information-governance, and ethical membership owns the decision, working from a documented process for judging whether AI is the right intervention at all — not just whether this product is good. Conflicts of interest are declared and managed, the people involved have protected time rather than doing this around the edges of other roles.",
...
export function getBestPractice(id: string): string | undefined {
  return bestPracticeByDimension[id];
}
